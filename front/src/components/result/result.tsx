...
function Result() {
  ...
  const winnerPercentage =
    totalVotants > 0 ? Math.round((winner.votes / totalVotants) * 100) : 0;

  // Taux de participation
  const participation =
    totalInscrits > 0 ? Math.round((totalVotants / totalInscrits) * 100) : 0;
        ...
        <section className="mb-6 overflow-hidden rounded-3xl bg-[#D4AF37] shadow-xl sm:mb-8">
          ...
          <div className="flex flex-col items-center gap-6 p-5 sm:gap-8 sm:p-10 md:flex-row">
            ...
            <div className="w-full flex-1 text-center md:text-left">
              ...
              <p className="mt-1 font-semibold text-[#3C3C3B]/70">voix</p>
        ...
        <section className="mb-8 rounded-3xl bg-white p-5 shadow-lg sm:mb-10 sm:p-8">
          ...
          <div className="grid gap-4 sm:grid-cols-3 sm:gap-6">
            ...
            <div className="rounded-2xl bg-[#3C3C3B] p-5 text-center">
              ...
              <p className="mt-1 text-sm text-white/60">personnes ont voté</p>
            </div>
            ...
            <div className="rounded-2xl bg-[#3C3C3B] p-5 text-center">
              ...
              <p className="mt-1 text-sm text-white/60">personnes inscrites</p>
            </div>
