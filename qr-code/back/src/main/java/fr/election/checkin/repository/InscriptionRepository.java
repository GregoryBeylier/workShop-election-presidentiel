...
public interface InscriptionRepository extends JpaRepository<Inscription, Integer> {
	...
	// Verrouille la ligne (SELECT ... FOR UPDATE) : deux check-in, ou un check-in et un vote appli,
	// sur la même inscription passent l'un après l'autre. Le futur endpoint de vote doit prendre ce même verrou.
